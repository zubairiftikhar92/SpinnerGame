    ...
    <div class="signup_login">
        <section class="wrapper">
            <div class="form signup">
                <header style="margin-bottom: 25px;">Register</header>
                <form id="registrationForm" action="{{ route('spinner-game-registeration') }}" method="POST">
                    @csrf

                    <input style="margin-top:15px " type="text" class="form-control" id="dsponserid" name="dsponserid"
                        placeholder="Your Friend Email" value="{{ $user_email }}" readonly>
                    @error('dsponserid')
                    ...
                    <div class="checkbox">
                        ...
                        <label for="signupCheck">
                            <a href="https://theunitywealth.com/termsconditions" target="_blank">I accept all terms &
                                conditions</a>
                        </label>
                    </div>

                    <div id="termsError" style="color: red;margin-top:-20px"></div>
                <small style="color: white">Join our spin and win game to earn Nims Token. For extra reward please use your friends referral email ID.</small>
